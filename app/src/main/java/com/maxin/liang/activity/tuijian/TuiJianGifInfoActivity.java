...
public class TuiJianGifInfoActivity extends BaseActivity {


    @Bind(R.id.jcv_infovideoplayer)
    ImageView jcvInfovideoplayer;
    @Bind(R.id.info_text)
    TextView infoText;
    ...
    public void initData() {
        ...
        Glide.with(this).load(videoUrl).asGif().into(jcvInfovideoplayer);
        Log.e("TAG222", ""+videoUrl);
    ...
    public int getLayoutId() {
        return R.layout.activity_tui_jian_gif_info;
    }
    ...
    private void getDataFromNet(String url) {
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onError(Call call, Exception e, int id) {
                Log.e("TuiJianGifInfoActivity", "onError= "+e.getMessage());
            }
