...
public class NetConfig {
    ...
    //家具url
    public final static String FURNITURE_URL = BASE_URL + "goods/goodsShare?app_key=Android&cat_code=0055&count=10&coverId=1&page=1&sig=6E1DEF1DAFF84909ECD98F32FE6CDAD5%7C536890620070968&v=1.0";
    //家居
    public final static String HOME_HOUSE_URL = BASE_URL + "goods/goodsShare?app_key=Android&cat_code=0045&count=10&coverId=1&page=1&sig=3D3968703BE211CC6D931C9D4F737FB4%7C290216330933368&v=1.0";
    //文具
    public final static String STATIONERY_URL = BASE_URL + "goods/goodsShare?app_key=Android&cat_code=0062&count=10&coverId=1&page=1&sig=6E1DEF1DAFF84909ECD98F32FE6CDAD5%7C536890620070968&v=1.0";
    //数码
    public final static String DIGITAL_URL = BASE_URL + "goods/goodsShare?app_key=Android&cat_code=0069&count=10&coverId=1&page=1&sig=6E1DEF1DAFF84909ECD98F32FE6CDAD5%7C536890620070968&v=1.0";
    //玩乐
    public final static String LIBERTINISM_URL = BASE_URL +
    ...
    //厨卫
    public final static String KITCHEN_URL = BASE_URL +
    ...
    //美食
    public final static String CATE_URL = BASE_URL +
    ...
    //男装
    public final static String MEN_URL = BASE_URL +
    ...
    //女装
    public final static String WOMEN_URL = BASE_URL +
    ...
    //童装
    public final static String CHILDREN_URL = BASE_URL +
    ...
    //鞋包
    public final static String SHOES_URL = BASE_URL +
    ...
    //配饰
    public final static String ACCESSORY_URL = BASE_URL +
    ...
    //美护
    public final static String BEAUTYCARE_URL = BASE_URL +
    ...
    //户外
    public final static String OUTDOORS_URL = BASE_URL +
    ...
    //植物
    public final static String PLANT_URL = BASE_URL +
    ...
    //图书
    public final static String BOOKS_URL = BASE_URL +
    ...
    //商店 推荐
    public final static String RECOMMEND_URL = BASE_URL +
    ...
    //艺术
    public final static String ART_URL = BASE_URL +
    ...
    public final static String BRAND_GOODS_DETAILS_URL = BASE_URL +
    ...
    public final static String HOME_PAGER_URL = BASE_URL +
    ...
    public final static String EXPERT_LIKE_URL = BASE_URL +
    ...
    public final static String EXPERT_INFR_URL = BASE_URL +
    ...
    //    最受欢迎：
    public final static String EXPERT_MENU_WELCOME_URL = BASE_URL +
    ...
    //    最新推荐：　
    public final static String EXPERT_MENU_NEWR_URL = BASE_URL +
    ...
    //    最新加入：　
    public final static String EXPERT_MENU_NEWJ_URL = BASE_URL +
